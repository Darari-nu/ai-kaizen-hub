...
const NOTES = {
  ...
  '008-shanai-system': { status: 'fix', note: '🔄8/19夜の本人加筆を回収: 「マニュアルを探す旅は〜」の1文を削除しました。ほかは8/19カード方式版のまま。OKの一言で✅にします。Copilot実物スクショは引き続き画面収録の許可待ち。' },
  ...
  '058-gaichuusaki-ai': { status: 'ok', note: '✅8/19本人検品OK。本人加筆6箇所(「1点！」「わかります。ただ、」「発注者視点からも」等)を回収し、内部リンク2本を削除(新ルールE15: 未公開記事へのリンク禁止)。図解2点+OGPの画像生成に着手します。' },
  '059-eu-toumeisei': { status: 'fix', note: '🔄8/19検品反映: 本人の言い換え3箇所(輪切り→わける・距離感→やり方)を回収。「ぼくのスタンスを言い切ります」節はご指摘どおり削除しました(学び=D10「ぼくらがやっていないことを読者に勧めない」として台帳化)。内部リンク2本削除。再検品お願いします。' },
  '060-kinshi-ai': { status: 'fix', note: '🔄8/19検品反映: 新題名「禁止されているAI」を回収(hookも合わせて変更しました・要確認)。「なるべくわかりやすく」「軍事利用目的などの」等の本人修正を回収、内部リンク3本削除。🔴認識確認: 「使ってはいけない」だと読者個人の利用の話に見えるが、第5条は提供・利用を含めて「そういうAIそのものが禁止されている」規制なので「禁止されているAI」が正確——この理解で合っていますか。' },
  '061-jibun-data': { status: 'fix', note: '🔄8/19検品反映: 題名を本人原題「会社に眠る『自分データ』は、AI時代の宝の山かもしれない」に変更、本人加筆7箇所(「立ち止まりましょう！」「梯子を外すようでスミマセン」等)を回収。「会社の規定の確認が先です」ブロックはご指摘どおり削除して確認2つに(学び=D11として台帳化)。内部リンク2本削除。⚠️「※会社員の方限定ですw」の※は機械検査NGのため外して取り込みました(※復活希望なら例外を作ります)。' },
};
