...
const NOTES = {
  ...
  'page-kousei-minaoshi': { status: 'new', note: '【新設③・未公開】サイト構成見直し(8/19両部長答申どおり実装済み)。トップ3カードの行き先変更+棚ページ2枚新設+/articles/新着順化。確認3点は紹介文の通り: ①棚の名前と説明文 ②ISO連載の予告8枚を出すか ③公開GO/NG(GOでpush)' },
