...
const NOTES = {
  ...
  '006-meishi-bot': { status: 'fix', note: '8/8反映: 「いつもの」削除、完成形LINEスクショ+AIブラウザの一文とスクショを記事内に配置しました。⚠️安全のため2箇所加工しています: ①LINEスクショはスプレッドシートの実URLが写っていたので、その手前でカット ②ブラウザのスクショは左サイドバーにDara系リポ名が写っていたので(レーン分離)、サイドバーごとカット。仕上がりを見て、問題なければOKください。⚙️8/10: 規程体系の整備に伴い、レベル表の参照を「AI利用規程・第3条」→「AI入力情報基準」(新ページ)に更新しました。' },
