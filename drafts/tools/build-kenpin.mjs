...
const NOTES = {
  ...
  '002-ai-rules-starter': '🔄8/7方針転換で全面書き直し: 「ルールを作っちゃおう」→「倫理・セキュリティ・法務の3点を押さえれば『いいよ』と言ってもらえる」に。003/006/008/010の参照文言も追従済み。再検品お願いします。',
  '003-chatgpt-kinshi': '🔄8/7指示反映で再構成: 禁止派を3タイプ化(ラッダイト/本気セキュリティ派=オンプレの伝聞/コンサル鵜呑み決裁者)。白状は「メールで飛ばしてコピペ」の実態に修正(アプリは作ってない)。想定問答にオンプレQ追加。再検品を。',
  '004-claude-team': '🔄8/7指示反映: AI倫理チーム→AI管理チーム(全箇所)、機械保守パックを置き換え候補から除外(事故る注記つき)、オチに「クレカ決済の経理処理1ヶ月」を追加。数字は8/6裁定のまま。再検品を。',
  '005-hiyou-taikoka': '✅8/6数字裁定反映済み(RPA5万→Team7名約2.2万=差引約2.8万)。8/7に保守パックの文言だけ004に合わせて「機械保守は対象外」と明記。',
