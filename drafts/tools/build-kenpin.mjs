...
const NOTES = {
  ...
  '003-chatgpt-kinshi': '「白状」パート(ChatGPT→外部メモ帳の抜け道)、公開して会社的にOKか最終判断を。',
  '004-claude-team': '⚠️005と数字が揺れてます。この記事=「月12万SaaS・10人で月$200」/005=「RPA月5万・7名約1.5万」。どちらに揃えるか、または「申請時見積10人→実際は7名契約」と経緯を書くか。',
  '005-hiyou-taikoka': '定量(RPA5万→Team7名1.5万=3.5万ダウン)と定性(金額化しない)の整理、実際の説明と合ってますか？',
